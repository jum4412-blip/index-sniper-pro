...
echo
echo "===== .env safety ====="
grep -E '^(DRY_RUN|SYMBOLS|LEVERAGE|CAPITAL_RATIO|RISK_PROFILE|MAX_OPEN_POSITIONS|MAX_DAILY_LOSS_PCT|SURVIVAL_|EXTERNAL_|ANTI_CHASE|MAX_ENTRY_EXTENSION_ATR|WHIPSAW_|LIVE_GUARD_|POSITION_|STRATEGY_HEARTBEAT_MINUTES|LOOP_SECONDS|INDEX_WEEKEND)=' .env || true
echo
echo "===== loop status ====="
