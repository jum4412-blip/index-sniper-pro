...
grep -E 'BT_SYMBOLS|BT_INITIAL_EQUITY|BT_CAPITAL_RATIO|BT_LEVERAGE|BT_MAX_ORDER_NOTIONAL_USDT|BT_OPT_MAX_ORDER_NOTIONAL_USDT|BT_K_VALUE|BT_EMA_FAST|BT_EMA_SLOW|BT_ATR_STOP_MULT|BT_ATR_TAKE_PROFIT_MULT|BT_ANTI_CHASE_ENABLED' .env
