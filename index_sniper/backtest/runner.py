...
def cfg_from_env(args) -> BacktestConfig:
    return BacktestConfig(
        ...
        whipsaw_filter_enabled=_bool(os.getenv("BT_WHIPSAW_FILTER_ENABLED", os.getenv("WHIPSAW_FILTER_ENABLED", "false")), False),
        whipsaw_filter_symbols=tuple(_symbols(os.getenv("BT_WHIPSAW_FILTER_SYMBOLS", os.getenv("WHIPSAW_FILTER_SYMBOLS", "BTCUSDT")))),
        whipsaw_filter_lookback_days=int(os.getenv("BT_WHIPSAW_FILTER_LOOKBACK_DAYS", os.getenv("WHIPSAW_FILTER_LOOKBACK_DAYS", "10"))),
        whipsaw_min_efficiency_ratio=float(os.getenv("BT_WHIPSAW_MIN_EFFICIENCY_RATIO", os.getenv("WHIPSAW_MIN_EFFICIENCY_RATIO", "0.22"))),
        whipsaw_max_flip_ratio=float(os.getenv("BT_WHIPSAW_MAX_FLIP_RATIO", os.getenv("WHIPSAW_MAX_FLIP_RATIO", "0.60"))),
